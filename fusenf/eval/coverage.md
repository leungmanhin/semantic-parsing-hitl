...
| fiction4 | external consumer (v4 texts) | 107 | 107 | 81 (76%) | 81 | 0 | 0 | 26 | 0 | — | 2ed18b93×107 |
| fiction5 | external consumer (pending re-parse set) | 9 | 9 | 6 (67%) | 6 | 0 | 0 | 3 | 0 | — | 2ed18b93×9 |
...
| lore_pending4 | external consumer (lore pending re-parse set 4) | 1 | 1 | 1 (100%) | 1 | 0 | 0 | 0 | 0 | — | 2ed18b93×1 |
| lore_pending5 | external consumer (lore pending re-parse set 5) | 2 | 2 | 2 (100%) | 2 | 0 | 0 | 0 | 0 | — | 2ed18b93×2 |
| events | external consumer (events.json; one record per episode = passage) | 74 | 27 | 8 (11%) | 8 | 4 | 5 | 10 | 47 | — | 2ed18b93×27 |
| events_pending | external consumer (events pending re-parse set; passages) | 82 | 82 | 16 (20%) | 16 | 0 | 14 | 52 | 0 | — | 2ed18b93×82 |
...
| qa_pending3 | external consumer (QA task stream set 3: 8 rewritten what-next entries; chained context) | 18 | 18 | 12 (67%) | 12 | 0 | 2 | 4 | 0 | — | 2ed18b93×18 |
