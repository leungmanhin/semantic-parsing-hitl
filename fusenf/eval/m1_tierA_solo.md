...
- `pairwise_agreement`: **0.859**
- `shape_agreement`: **0.859**
- `unanimity`: **0.808**
- `modal_share`: **0.923**
- `soft_jaccard_mismatch`: **0.255** (over 11 disagreeing pairs)
...
|---|---|---|---|---|
| tierA-000199 | decide | 0.00 | no | 0.33 |
| tierA-000073 | allow | 0.33 | no | 0.67 |
| tierA-000258 | die | 0.33 | no | 0.67 |
| tierA-000294 | teach | 0.33 | no | 0.67 |
