...
- `pairwise_agreement`: **0.317**
- `shape_agreement`: **0.333**
- `unanimity`: **0.317**
- `modal_share`: **0.658**
- `soft_jaccard_mismatch`: **0.485** (over 41 disagreeing pairs)
...
|---|---|
| `unclassified` | 22 |
| `decomposition-depth` | 15 |
| `optional-atom` | 2 |
| `tv-only` | 1 |
| `role-choice` | 1 |

> `unclassified` (22) needs the agent reviewer — these are the semantic buckets (genuine ambiguity vs a convention gap) that no program can separate.
...
| tierC-000089 | ? | 0.00 | no | 0.50 |
| tierC-000111 | ? | 0.00 | no | 0.50 |
| tierC-000113 | ? | 0.00 | no | 0.50 |
| tierC-000128 | ? | 0.00 | no | 0.50 |
...
| tierC-000320 | ? | 0.00 | no | 0.50 |
| tierC-000333 | ? | 0.00 | no | 0.50 |
| tierC-000337 | ? | 0.00 | no | 0.50 |
