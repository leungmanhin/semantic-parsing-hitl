...
- `unanimity`: **0.433**
- `modal_share`: **0.717**
- `soft_jaccard_mismatch`: **0.628** (over 34 disagreeing pairs)
...
> `unclassified` (20) needs the agent reviewer — these are the semantic buckets (genuine ambiguity vs a convention gap) that no program can separate.
