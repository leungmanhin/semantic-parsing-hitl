...
- `pairwise_agreement`: **0.967**
- `shape_agreement`: **0.967**
- `unanimity`: **0.950**
- `modal_share`: **0.983**
- `soft_jaccard_mismatch`: **0.889** (over 2 disagreeing pairs)
...
|---|---|---|---|---|
| pilot-000003 | event-ditrans | 0.33 | no | 0.67 |
