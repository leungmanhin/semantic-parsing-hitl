...
- anti-unified rules (support>=2): **46** — kinds {'lexical-collapse': 22, 'structural-alt': 24}; flagged fires_on_control: **0**; signals: **46**
...
| 2 (2×) | lexical-collapse | 0.48 | `(Member $C arrival)` | `(Member $C arrive)` |
...
| allow<-permit | 3 | au0030 |
| answer<-give_an_answer | 3 | au0026 |
| arrive<-arrival | 3 | au0031 |
| automobile<-car | 3 | au0043 |
...
| decide<-decision | 4 | au0028 |
| decide<-make_a_decision | 4 | au0028 |
| destroy<-destruction | 3 | au0020 (prov) |
| die<-kick_the_bucket | 3 | au0032 |
| difficult<-hard | 3 | au0015 |
| discover<-find_out | 3 | au0016 |
| exhausted<-very_tired | 3 | au0045 |
| give~receive | 4 | au0021 |
| huge<-very_big | 3 | au0025 |
| large<-big | 3 | au0013 |
| lend~borrow | 3 | au0039 |
| physician<-doctor | 3 | au0023 |
| postpone<-put_off | 3 | au0018 |
| reject<-turn_down | 3 | au0019 |
| repair<-fix | 4 | au0035 |
| repair<-mend | 4 | au0037 |
| require<-need | 3 | au0017 |
| teach~learn | 3 | au0040 |
| walk<-take_a_walk | 3 | au0038 (prov) |
