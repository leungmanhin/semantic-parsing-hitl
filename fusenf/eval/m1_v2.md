...
- `pairwise_agreement`: **0.833**
- `shape_agreement`: **0.833**
- `unanimity`: **0.750**
- `modal_share`: **0.917**
- `soft_jaccard_mismatch`: **0.802** (over 10 disagreeing pairs)
...
|---|---|---|
| tense-passive | 1 | 0.333 |
| modality-epist | 1 | 0.333 |
| negation | 1 | 0.333 |
| comparative | 1 | 0.333 |
| connective | 1 | 0.333 |
| categorical | 1 | 1.000 |
...
|---|---|---|---|---|
| pilot-000004 | tense-passive | 0.33 | no | 0.67 |
| pilot-000005 | modality-epist | 0.33 | no | 0.67 |
| pilot-000007 | negation | 0.33 | no | 0.67 |
| pilot-000011 | comparative | 0.33 | no | 0.67 |
...
| pilot-000019 | attitude | 1.00 | yes | 1.00 |
