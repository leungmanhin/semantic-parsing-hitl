...
- `pairwise_agreement`: **0.883**
- `shape_agreement`: **0.883**
- `unanimity`: **0.850**
- `modal_share`: **0.933**
- `soft_jaccard_mismatch`: **0.779** (over 7 disagreeing pairs)
...
|---|---|---|---|---|
| pilot-000018 | focus | 0.00 | no | 0.33 |
| pilot-000004 | tense-passive | 0.33 | no | 0.67 |
| pilot-000015 | disjunction | 0.33 | no | 0.67 |
