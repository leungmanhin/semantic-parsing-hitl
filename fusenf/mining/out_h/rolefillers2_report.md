...
|---|---|---|---|
| 0.60 | accompany.Agent (4) | appear.Agent (6) | person, sister |
...
- global entity-filler vocabularies: Theme 442 distinct (517 uses), Patient 371 distinct (449 uses); **64 filler classes under BOTH** (global cosine 0.520)
...
|---|---|---|---|
| start | Theme | 12 | appear, chant, cry, disappear, hear, improve |
...
| constitute | Theme | 1 | attack, full_fledged |
...
| move | Theme | headquarters 2, sammy 1, fish 0.5, school 0.5 |
