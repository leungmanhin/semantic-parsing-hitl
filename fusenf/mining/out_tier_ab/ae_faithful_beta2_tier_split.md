# §4.3.5 faithful pairs on `out_tier_ab` — tier split (tierA added to tierB; ae_faithful_beta2, adopted point)
...
|---|---|---|---|---|---|---|
| tierA-only | 8886 | 69 | 1540 | 1386 | 3606 | 2354 |
| tierB-only | 568 | 0 | 2 | 193 | 301 | 72 |
| cross | 2464 | 37 | 197 | 965 | 1287 | 15 |
| total | 11918 | 106 | 1739 | 2544 | 5194 | 2441 |
...
| 1.000 | 5 | tierA-only | tierA 4 | tierA 3 | `(And (Future $e0) (Member $x0 apple_harvest) (Patient $e0 $x0))` | `(And (Future $e0) (Member $x0 dress_rehearsal) (Patient $e0 $x0))` | (Member $x0 dress_rehearsal) -> (Member $x0 apple_harvest) |
...
| 0.993 | 5 | tierA-only | tierA 6 | tierA 6 | `(Member $x0 electrician)` | `(Member $x0 mechanic)` | (Member $x0 mechanic) -> (Member $x0 electrician) |
| 0.993 | 5 | tierA-only | tierA 6 | tierA 6 | `(Member $x0 mechanic)` | `(Member $x0 yard_floodlight)` | (Member $x0 yard_floodlight) -> (Member $x0 mechanic) |
| 0.993 | 5 | tierA-only | tierA 6 | tierA 5 | `(Member $x0 electrician)` | `(Member $x0 gearbox)` | (Member $x0 gearbox) -> (Member $x0 electrician) |
| 0.993 | 5 | tierA-only | tierA 6 | tierA 5 | `(Member $x0 electrician)` | `(Member $x0 seized)` | (Member $x0 seized) -> (Member $x0 electrician) |
| 0.993 | 5 | tierA-only | tierA 6 | tierA 5 | `(Member $x0 yard_floodlight)` | `(Member $x0 gearbox)` | (Member $x0 gearbox) -> (Member $x0 yard_floodlight) |
| 0.993 | 5 | tierA-only | tierA 6 | tierA 5 | `(Member $x0 yard_floodlight)` | `(Member $x0 seized)` | (Member $x0 seized) -> (Member $x0 yard_floodlight) |
| 0.991 | 5 | tierA-only | tierA 5 | tierA 4 | `(And (Agent $e0 $x0) (Member $x0 electrician) (Past $e0) (Patient $e0 $x1))` | `(And (Agent $e0 $x0) (Member $x0 mechanic) (Past $e0) (Patient $e0 $x1))` | (Member $x0 mechanic) -> (Member $x0 electrician) |

## Other exclusive passes (1633), by cosine
...
## Other overlapping passes (2544), by cosine
...
| 1.000 | tierA-only | tierA 7 | tierA 4 | 3 | `(And (Member $e0 cancel) (Patient $e0 $x0))` | `(And (Agent $e0 $x0) (Member $x0 tutor) (Member $x1 afternoon_session) (Patient $e0 $x1))` |
| 1.000 | tierA-only | tierA 7 | tierA 4 | 3 | `(And (Member $e0 cancel) (Patient $e0 $x0))` | `(And (Agent $e0 $x0) (Member $x0 tutor) (Patient $e0 $x1))` |
| 1.000 | tierA-only | tierA 7 | tierA 4 | 3 | `(And (Member $e0 cancel) (Patient $e0 $x0))` | `(And (Agent $e0 $x0) (Member $x1 afternoon_session) (Patient $e0 $x1))` |
| 1.000 | tierA-only | tierA 7 | tierA 4 | 3 | `(And (Member $e0 cancel) (Patient $e0 $x0))` | `(And (Inheritance afternoon_session session) (Member $x0 afternoon_session) (Patient $e0 $x0))` |
| 1.000 | tierA-only | tierA 7 | tierA 4 | 3 | `(And (Member $e0 cancel) (Patient $e0 $x0))` | `(And (Member $x0 afternoon_session) (Patient $e0 $x0))` |
...
## Other nested passes (5194), by cosine
...
| 1.000 | tierA-only | tierA 6 | tierA 5 | 5 | `(And (Inheritance yard_floodlight floodlight) (Member $x0 yard_floodlight))` | `(And (Agent $e0 $x0) (Member $x1 yard_floodlight) (Past $e0) (Patient $e0 $x1))` |
| 1.000 | tierA-only | tierA 6 | tierA 5 | 5 | `(And (Inheritance yard_floodlight floodlight) (Member $x0 yard_floodlight))` | `(And (Inheritance yard_floodlight floodlight) (Member $x0 yard_floodlight) (Past $e0) (Patient $e0 $x0))` |
| 1.000 | tierA-only | tierA 6 | tierA 5 | 5 | `(And (Inheritance yard_floodlight floodlight) (Member $x0 yard_floodlight))` | `(And (Agent $e0 $x0) (Member $x1 yard_floodlight) (Patient $e0 $x1))` |
| 1.000 | tierA-only | tierA 6 | tierA 5 | 5 | `(And (Inheritance yard_floodlight floodlight) (Member $x0 yard_floodlight))` | `(And (Member $x0 yard_floodlight) (Patient $e0 $x0))` |
| 1.000 | tierA-only | tierA 6 | tierA 5 | 5 | `(Inheritance yard_floodlight floodlight)` | `(And (Agent $e0 $x0) (Member $x1 yard_floodlight) (Past $e0) (Patient $e0 $x1))` |
| 1.000 | tierA-only | tierA 6 | tierA 5 | 5 | `(Inheritance yard_floodlight floodlight)` | `(And (Agent $e0 $x0) (Member $x1 yard_floodlight) (Patient $e0 $x1))` |
| 1.000 | tierA-only | tierA 6 | tierA 5 | 5 | `(Inheritance yard_floodlight floodlight)` | `(And (Member $x0 yard_floodlight) (Past $e0) (Patient $e0 $x0))` |
...
| 1.000 | tierA-only | tierA 6 | tierA 5 | 5 | `(Member $x0 electrician)` | `(And (Agent $e0 $x0) (Member $x1 yard_floodlight) (Patient $e0 $x1))` |
...
| 1.000 | tierA-only | tierA 6 | tierA 5 | 5 | `(Member $x0 yard_floodlight)` | `(And (Agent $e0 $x0) (Member $x1 yard_floodlight) (Patient $e0 $x1))` |
| 1.000 | tierA-only | tierA 6 | tierA 5 | 5 | `(Member $x0 yard_floodlight)` | `(And (Member $x0 yard_floodlight) (Past $e0) (Patient $e0 $x0))` |
...
## Other same-records passes (2441), by cosine
