# §4.3.5 faithful pairs on `out_tier_b` — tier split (tierA added to tierB; ae_faithful, adopted point)
...
| tierB-only | 861 | 4 | 18 | 340 | 387 | 116 |
| cross | 0 | 0 | 0 | 0 | 0 | 0 |
| total | 861 | 4 | 18 | 340 | 387 | 116 |
...
|---|---|---|---|---|---|---|---|
| 0.931 | 4 | tierB-only | tierB 3 | tierB 3 | `(Agent $e0 david)` | `(Agent $e0 mark)` | (Agent $e0 mark) -> (Agent $e0 david) |
| 0.918 | 5 | tierB-only | tierB 6 | tierB 4 | `(And (Past $e0) (Patient $e0 $x0) (Source $e0 $x1))` | `(And (Past $e0) (Source $e0 $x0) (Theme $e0 $x1))` | (Theme $e0 $x1) -> (Patient $e0 $x0) |
| 0.898 | 5 | tierB-only | tierB 8 | tierB 5 | `(And (Patient $e0 $x0) (Source $e0 $x1))` | `(And (Source $e0 $x0) (Theme $e0 $x1))` | (Theme $e0 $x1) -> (Patient $e0 $x0) |
| 0.877 | 5 | tierB-only | tierB 8 | tierB 5 | `(And (Agent $e0 $x0) (GroupOf $x0 person))` | `(And (GroupOf $x0 person) (Patient $e0 $x0))` | (Patient $e0 $x0) -> (Agent $e0 $x0) |

## Other exclusive passes (14), by cosine

| cosine | bucket | A records | B records | shared | A | B |
|---|---|---|---|---|---|---|
| 0.928 | tierB-only | tierB 8 | tierB 4 | 0 | `(And (Patient $e0 $x0) (Source $e0 $x1))` | `(And (Past $e0) (Source $e0 $x0) (Theme $e0 $x1))` |
| 0.909 | tierB-only | tierB 5 | tierB 3 | 0 | `(And (Goal $e0 $x0) (Member $e0 go) (Past $e0))` | `(And (Goal $e0 bed) (Member $e0 go))` |
| 0.909 | tierB-only | tierB 5 | tierB 3 | 0 | `(And (Goal $e0 $x0) (Member $e0 go) (Past $e0))` | `(Goal $e0 bed)` |
| 0.905 | tierB-only | tierB 6 | tierB 3 | 0 | `(And (Goal $e0 $x0) (Member $e0 go))` | `(And (Goal $e0 bed) (Member $e0 go))` |
| 0.905 | tierB-only | tierB 6 | tierB 3 | 0 | `(And (Goal $e0 $x0) (Member $e0 go))` | `(Goal $e0 bed)` |
| 0.901 | tierB-only | tierB 5 | tierB 4 | 0 | `(And (Goal $e0 $x0) (Member $e0 go) (Past $e0))` | `(Time $e0 night)` |
| 0.895 | tierB-only | tierB 5 | tierB 3 | 0 | `(And (Goal $e0 $x0) (Member $e0 go) (Past $e0))` | `(And (Past $e0) (Time $e0 night))` |
| 0.895 | tierB-only | tierB 6 | tierB 4 | 0 | `(And (Goal $e0 $x0) (Member $e0 go))` | `(Time $e0 night)` |
| 0.893 | tierB-only | tierB 6 | tierB 5 | 0 | `(And (Past $e0) (Patient $e0 $x0) (Source $e0 $x1))` | `(And (Source $e0 $x0) (Theme $e0 $x1))` |
| 0.890 | tierB-only | tierB 6 | tierB 3 | 0 | `(And (Goal $e0 $x0) (Member $e0 go))` | `(And (Past $e0) (Time $e0 night))` |
| 0.883 | tierB-only | tierB 5 | tierB 3 | 0 | `(And (GroupOf $x0 person) (Patient $e0 $x0))` | `(And (Member $e0 travel) (Past $e0))` |
| 0.878 | tierB-only | tierB 7 | tierB 5 | 0 | `(And (Agent $e0 $x0) (GroupOf $x0 person) (Past $e0))` | `(And (GroupOf $x0 person) (Patient $e0 $x0))` |
| 0.876 | tierB-only | tierB 5 | tierB 5 | 0 | `(And (GroupOf $x0 person) (Patient $e0 $x0))` | `(Member $e0 travel)` |
| 0.850 | tierB-only | tierB 3 | tierB 3 | 0 | `(And (GroupOf $x0 person) (Past $e0) (Patient $e0 $x0))` | `(And (Member $e0 travel) (Past $e0))` |

## Other overlapping passes (340), by cosine
...
| 0.999 | tierB-only | tierB 5 | tierB 5 | 4 | `(And (Member $e0 get) (Ongoing $e0))` | `(And (Member $e0 get) (Result $e0 $e1))` |
...
| 0.997 | tierB-only | tierB 4 | tierB 3 | 2 | `(And (Location $e0 $x0) (Member $x0 table) (Past $e0))` | `(And (Experiencer $e0 $x0) (Location $e0 $x1) (Ongoing $e0) (Past $e0))` |
| 0.997 | tierB-only | tierB 4 | tierB 3 | 2 | `(And (Location $e0 $x0) (Member $x0 table))` | `(And (Experiencer $e0 $x0) (Location $e0 $x1) (Ongoing $e0) (Past $e0))` |
| 0.996 | tierB-only | tierB 4 | tierB 4 | 3 | `(And (Member $e0 get) (Ongoing $e0) (Patient $e0 $x0))` | `(And (Member $e0 get) (Ongoing $e0) (Result $e0 $e1))` |
| 0.996 | tierB-only | tierB 8 | tierB 8 | 6 | `(And (Member $e0 hear) (Past $e0))` | `(And (Past $e0) (Stimulus $e0 $x0))` |
...
| 0.995 | tierB-only | tierB 9 | tierB 8 | 6 | `(Member $e0 hear)` | `(And (Past $e0) (Stimulus $e0 $x0))` |
| 0.995 | tierB-only | tierB 5 | tierB 4 | 3 | `(And (Member $e0 get) (Result $e0 $e1))` | `(And (Member $e0 get) (Ongoing $e0) (Patient $e0 $x0))` |
| 0.995 | tierB-only | tierB 5 | tierB 5 | 3 | `(And (Member $e0 get) (Patient $e0 $x0))` | `(And (Member $e0 get) (Result $e0 $e1))` |
| 0.995 | tierB-only | tierB 4 | tierB 4 | 2 | `(And (Experiencer $e0 $x0) (Ongoing $e0) (Past $e0))` | `(And (Location $e0 $x0) (Member $x0 table) (Past $e0))` |
| 0.995 | tierB-only | tierB 4 | tierB 4 | 2 | `(And (Experiencer $e0 $x0) (Ongoing $e0) (Past $e0))` | `(And (Location $e0 $x0) (Member $x0 table))` |
| 0.994 | tierB-only | tierB 8 | tierB 7 | 6 | `(And (Member $e0 hear) (Past $e0))` | `(And (Member $e0 hear) (Stimulus $e0 $x0))` |
| 0.994 | tierB-only | tierB 6 | tierB 4 | 3 | `(And (Experiencer $e0 $x0) (Location $e0 $x1) (Past $e0))` | `(And (Experiencer $e0 $x0) (Ongoing $e0) (Past $e0))` |
...
| 0.992 | tierB-only | tierB 4 | tierB 3 | 1 | `(Time $e0 night)` | `(And (Goal $e0 bed) (Member $e0 go))` |
| 0.992 | tierB-only | tierB 4 | tierB 3 | 1 | `(Time $e0 night)` | `(Goal $e0 bed)` |
| 0.991 | tierB-only | tierB 7 | tierB 3 | 1 | `(And (Agent $e0 $x0) (GroupOf $x0 person) (Past $e0))` | `(And (Member $e0 travel) (Past $e0))` |

## Other nested passes (387), by cosine
...
| 1.000 | tierB-only | tierB 4 | tierB 3 | 3 | `(And (Past $e0) (Past $e1) (Theme $e0 $e1))` | `(And (Member $e0 stop) (Past $e0) (Past $e1) (Theme $e0 $e1))` |
| 1.000 | tierB-only | tierB 4 | tierB 3 | 3 | `(And (Past $e0) (Past $e1) (Theme $e0 $e1))` | `(And (Member $e0 stop) (Past $e1) (Theme $e0 $e1))` |
| 1.000 | tierB-only | tierB 4 | tierB 3 | 3 | `(And (Past $e0) (Past $e1) (Theme $e0 $e1))` | `(And (Member $e0 stop) (Past $e0) (Theme $e0 $e1))` |
| 1.000 | tierB-only | tierB 4 | tierB 3 | 3 | `(And (Past $e0) (Past $e1) (Theme $e0 $e1))` | `(And (Member $e0 stop) (Theme $e0 $e1))` |
| 1.000 | tierB-only | tierB 4 | tierB 3 | 3 | `(And (Past $e0) (Theme $e1 $e0))` | `(And (Member $e0 stop) (Past $e0) (Past $e1) (Theme $e0 $e1))` |
| 1.000 | tierB-only | tierB 4 | tierB 3 | 3 | `(And (Past $e0) (Theme $e1 $e0))` | `(And (Member $e0 stop) (Past $e1) (Theme $e0 $e1))` |
| 1.000 | tierB-only | tierB 4 | tierB 3 | 3 | `(And (Past $e0) (Theme $e1 $e0))` | `(And (Member $e0 stop) (Past $e0) (Theme $e0 $e1))` |
| 1.000 | tierB-only | tierB 4 | tierB 3 | 3 | `(And (Past $e0) (Theme $e1 $e0))` | `(And (Member $e0 stop) (Theme $e0 $e1))` |
