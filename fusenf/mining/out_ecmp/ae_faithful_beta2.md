...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 32 | 2 | 0.80 | 19854 | 1840 (113) | 2386 | 6900 | 8728 | 3624 | 100 | 19446 | 52 (20 / 581) | 40411 / 17855 | 13663 / 304 | 19854 / 1840 | 3/26 | none |
| 32 | 2 | 0.85 | 19323 | 1532 (98) | 2260 | 6803 | 8728 | 3579 | 100 | 19089 | 54 (28 / 581) | 37311 / 15248 | 13503 / 303 | 19323 / 1532 | 3/26 | none |
| 32 | 2 | 0.90 | 18990 | 1418 (85) | 2112 | 6732 | 8728 | 3557 | 99 | 18326 | 57 (33 / 581) | 32048 / 10478 | 13402 / 303 | 18990 / 1418 | 3/26 | none |
| 32 | 2 | 0.95 | 18088 | 1334 (64) | 1606 | 6420 | 8728 | 3451 | 99 | 17471 | 62 (42 / 581) | 27566 / 7358 | 13021 / 303 | 18088 / 1334 | 3/26 | none |
...
|---|---|---|---|---|---|---|---|---|
| 1.000 | 5/5 | exclusive (shape-parallel) | 0.39 / 0.39 | `(And (Agent $e0 $x0) (Member $x0 council) (Patient $e0 $x1))` (4) | `(And (Agent $e0 $x0) (Member $x0 tutor) (Patient $e0 $x1))` (4) | 0 | A council cancels the summer fair. | A tutor cancels the afternoon session. |
| 1.000 | 5/5 | exclusive (shape-parallel) | 0.39 / 0.39 | `(And (Agent $e0 $x0) (Member $x1 afternoon_session) (Patient $e0 $x1))` (4) | `(And (Agent $e0 $x0) (Member $x1 summer_fair) (Patient $e0 $x1))` (4) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
| 1.000 | 5/5 | exclusive (shape-parallel) | 0.39 / 0.39 | `(And (Member $x0 afternoon_session) (Patient $e0 $x0))` (4) | `(And (Member $x0 summer_fair) (Patient $e0 $x0))` (4) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
...
| 1.000 | 5/5 | exclusive (shape-parallel) | 0.22 / 0.22 | `(And (Member $e0 commence) (Patient $e0 $x0))` (4) | `(And (Member $e0 start) (Patient $e0 $x0))` (4) | 0 | A shoreline survey commences at dawn. | A shoreline survey starts at dawn. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.40 / 0.39 | `(And (Agent $e0 $x0) (Member $x0 tutor))` (5) | `(And (Agent $e0 $x0) (Member $x0 council))` (4) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.40 / 0.39 | `(And (Member $x0 apple_harvest) (Patient $e0 $x0))` (5) | `(And (Member $x0 dress_rehearsal) (Patient $e0 $x0))` (4) | 0 | The apple harvest begins in September. | The dress rehearsal begins after lunch. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.34 / 0.31 | `(And (Future $e0) (Member $x0 apple_harvest) (Patient $e0 $x0))` (4) | `(And (Future $e0) (Member $x0 dress_rehearsal) (Patient $e0 $x0))` (3) | 0 | The apple harvest begins in September. | The dress rehearsal begins after lunch. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.40 / 0.40 | `(Inheritance apple_harvest harvest)` (5) | `(Inheritance dress_rehearsal rehearsal)` (5) | 0 | The apple harvest begins in September. | The dress rehearsal begins after lunch. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.40 / 0.40 | `(Member $x0 apple_harvest)` (5) | `(Member $x0 dress_rehearsal)` (5) | 0 | The apple harvest begins in September. | The dress rehearsal begins after lunch. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.40 / 0.40 | `(Member $x0 apple_harvest)` (5) | `(Member $x0 lunch)` (5) | 0 | The apple harvest begins in September. | The dress rehearsal begins after lunch. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.40 / 0.41 | `(Inheritance afternoon_session session)` (5) | `(Inheritance summer_fair fair)` (5) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.40 / 0.41 | `(Member $x0 afternoon_session)` (5) | `(Member $x0 council)` (5) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.40 / 0.41 | `(Member $x0 afternoon_session)` (5) | `(Member $x0 summer_fair)` (5) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.41 / 0.40 | `(Member $x0 council)` (5) | `(Member $x0 tutor)` (5) | 0 | A council cancels the summer fair. | A tutor cancels the afternoon session. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.41 / 0.40 | `(Member $x0 summer_fair)` (5) | `(Member $x0 tutor)` (5) | 0 | A council cancels the summer fair. | A tutor cancels the afternoon session. |
| 0.996 | 5/5 | exclusive (shape-parallel) | 0.42 / 0.22 | `(And (Member $e0 begin) (Patient $e0 $x0))` (7) | `(And (Member $e0 commence) (Patient $e0 $x0))` (4) | 0 | A shoreline survey begins at dawn. | A shoreline survey commences at dawn. |
| 0.996 | 5/5 | exclusive (shape-parallel) | 0.42 / 0.22 | `(And (Member $e0 begin) (Patient $e0 $x0))` (7) | `(And (Member $e0 start) (Patient $e0 $x0))` (4) | 0 | A shoreline survey begins at dawn. | A shoreline survey starts at dawn. |
| 0.992 | 5/5 | exclusive (shape-parallel) | 0.20 / 0.20 | `(Member $x0 archive)` (5) | `(Member $x0 greenhouse)` (5) | 0 | A fire destroys the archive. | A storm destroys the greenhouse. |
| 0.992 | 5/5 | exclusive (shape-parallel) | 0.20 / 0.20 | `(Member $x0 archive)` (5) | `(Member $x0 storm)` (5) | 0 | A fire destroys the archive. | A storm destroys the greenhouse. |
| 0.992 | 5/5 | exclusive (shape-parallel) | 0.20 / 0.20 | `(Member $x0 fire)` (5) | `(Member $x0 greenhouse)` (5) | 0 | A fire destroys the archive. | A storm destroys the greenhouse. |
| 0.992 | 5/5 | exclusive (shape-parallel) | 0.20 / 0.20 | `(Member $x0 fire)` (5) | `(Member $x0 storm)` (5) | 0 | A fire destroys the archive. | A storm destroys the greenhouse. |
...
| 1.000 | 5/5 | same-records (shape-parallel) | 0.64 / 0.64 | `(And (Agent $e0 $x0) (Member $e0 buy) (Past $e0))` (14) | `(And (Member $e0 buy) (Past $e0) (Theme $e0 $x0))` (14) | 14 | The depot bought two forklifts. | The depot bought two forklifts. |
...
| 1.000 | 5/5 | same-records (shape-parallel) | 0.64 / 0.64 | `(And (Agent $e0 $x0) (Member $e0 buy))` (14) | `(And (Member $e0 buy) (Theme $e0 $x0))` (14) | 14 | The depot bought two forklifts. | The depot bought two forklifts. |
