...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 32 | 0.5 | 0.80 | 19445 | 1623 (97) | 2289 | 6879 | 8654 | 3590 | 100 | 19115 | 47 (25 / 595) | 39258 / 16903 | 14737 / 339 | 19445 / 1623 | 2/26 | none |
| 32 | 0.5 | 0.85 | 19136 | 1482 (88) | 2189 | 6811 | 8654 | 3553 | 100 | 18999 | 50 (27 / 595) | 36332 / 14410 | 14605 / 339 | 19136 / 1482 | 2/26 | none |
| 32 | 0.5 | 0.90 | 18984 | 1400 (77) | 2159 | 6771 | 8654 | 3535 | 99 | 18514 | 55 (30 / 595) | 33215 / 11725 | 14535 / 323 | 18984 / 1400 | 2/26 | none |
| 32 | 0.5 | 0.95 | 17983 | 1245 (58) | 1643 | 6441 | 8654 | 3425 | 99 | 17652 | 61 (40 / 595) | 27310 / 7248 | 14120 / 317 | 17983 / 1245 | 2/26 | none |
| 64 | 0.5 | 0.80 | 18447 | 724 (105) | 1697 | 6301 | 9725 | 4113 | 106 | 17905 | 108 (32 / 190) | 20097 / 1572 | 5320 / 45 | 18447 / 724 | 5/26 | none |
| 64 | 0.5 | 0.85 | 18012 | 717 (101) | 1429 | 6141 | 9725 | 4045 | 105 | 17567 | 112 (39 / 190) | 19355 / 1381 | 5249 / 45 | 18012 / 717 | 4/26 | none |
| 64 | 0.5 | 0.90 | 17126 | 712 (97) | 1247 | 5442 | 9725 | 3888 | 105 | 16816 | 116 (48 / 190) | 18147 / 1142 | 5185 / 45 | 17126 / 712 | 2/26 | none |
| 64 | 0.5 | 0.95 | 15955 | 584 (81) | 1064 | 4582 | 9725 | 3678 | 105 | 15567 | 130 (58 / 190) | 16828 / 913 | 4854 / 45 | 15955 / 584 | 2/26 | none |
| 128 | 0.5 | 0.80 | 9209 | 24 (9) | 261 | 3281 | 5643 | 3358 | 106 | 8717 | 198 (54 / 97) | 12240 / 52 | 2462 / 8 | 9209 / 24 | 2/26 | none |
| 128 | 0.5 | 0.85 | 8484 | 24 (9) | 213 | 2604 | 5643 | 3140 | 106 | 7909 | 206 (64 / 97) | 11364 / 50 | 2368 / 8 | 8484 / 24 | 2/26 | none |
| 128 | 0.5 | 0.90 | 7491 | 20 (7) | 109 | 1807 | 5555 | 2858 | 105 | 7347 | 217 (81 / 97) | 10357 / 36 | 2211 / 8 | 7491 / 20 | 1/26 | none |
| 128 | 0.5 | 0.95 | 6859 | 17 (6) | 45 | 1258 | 5539 | 2648 | 103 | 6747 | 231 (105 / 97) | 9719 / 33 | 2039 / 8 | 6859 / 17 | 1/26 | none |
...
|---|---|---|---|---|---|---|---|---|
| 1.000 | 5/5 | exclusive (shape-parallel) | 0.39 / 0.40 | `(And (Agent $e0 $x0) (Member $x0 council) (Patient $e0 $x1))` (4) | `(And (Agent $e0 $x0) (Member $x0 tutor) (Patient $e0 $x1))` (4) | 0 | A council cancels the summer fair. | A tutor cancels the afternoon session. |
| 1.000 | 5/5 | exclusive (shape-parallel) | 0.40 / 0.39 | `(And (Agent $e0 $x0) (Member $x1 afternoon_session) (Patient $e0 $x1))` (4) | `(And (Agent $e0 $x0) (Member $x1 summer_fair) (Patient $e0 $x1))` (4) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
| 1.000 | 5/5 | exclusive (shape-parallel) | 0.23 / 0.23 | `(And (Member $e0 commence) (Patient $e0 $x0))` (4) | `(And (Member $e0 start) (Patient $e0 $x0))` (4) | 0 | A shoreline survey commences at dawn. | A shoreline survey starts at dawn. |
| 1.000 | 5/5 | exclusive (shape-parallel) | 0.40 / 0.39 | `(And (Member $x0 afternoon_session) (Patient $e0 $x0))` (4) | `(And (Member $x0 summer_fair) (Patient $e0 $x0))` (4) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
| 1.000 | 5/5 | exclusive (shape-parallel) | 0.33 / 0.33 | `(And (Agent $e0 $x0) (Member $e0 cancel) (Member $x0 council) (Patient $e0 $x1))` (3) | `(And (Agent $e0 $x0) (Member $e0 cancel) (Member $x0 tutor) (Patient $e0 $x1))` (3) | 0 | A council cancels the summer fair. | A tutor cancels the afternoon session. |
| 1.000 | 5/5 | exclusive (shape-parallel) | 0.33 / 0.33 | `(And (Agent $e0 $x0) (Member $e0 cancel) (Member $x1 afternoon_session) (Patient $e0 $x1))` (3) | `(And (Agent $e0 $x0) (Member $e0 cancel) (Member $x1 summer_fair) (Patient $e0 $x1))` (3) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
| 1.000 | 5/5 | exclusive (shape-parallel) | 0.33 / 0.33 | `(And (Agent $e0 $x0) (Member $e0 cancel) (Member $x0 council))` (3) | `(And (Agent $e0 $x0) (Member $e0 cancel) (Member $x0 tutor))` (3) | 0 | A council cancels the summer fair. | A tutor cancels the afternoon session. |
| 1.000 | 5/5 | exclusive (shape-parallel) | 0.33 / 0.33 | `(And (Member $e0 cancel) (Member $x0 afternoon_session) (Patient $e0 $x0))` (3) | `(And (Member $e0 cancel) (Member $x0 summer_fair) (Patient $e0 $x0))` (3) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
| 0.999 | 5/5 | exclusive (shape-parallel) | 0.41 / 0.39 | `(And (Agent $e0 $x0) (Member $x0 tutor))` (5) | `(And (Agent $e0 $x0) (Member $x0 council))` (4) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.41 / 0.41 | `(Inheritance afternoon_session session)` (5) | `(Inheritance summer_fair fair)` (5) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.41 / 0.41 | `(Member $x0 afternoon_session)` (5) | `(Member $x0 council)` (5) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.41 / 0.41 | `(Member $x0 afternoon_session)` (5) | `(Member $x0 summer_fair)` (5) | 0 | A tutor cancels the afternoon session. | A council cancels the summer fair. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.41 / 0.41 | `(Member $x0 council)` (5) | `(Member $x0 tutor)` (5) | 0 | A council cancels the summer fair. | A tutor cancels the afternoon session. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.41 / 0.41 | `(Member $x0 summer_fair)` (5) | `(Member $x0 tutor)` (5) | 0 | A council cancels the summer fair. | A tutor cancels the afternoon session. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.42 / 0.23 | `(And (Member $e0 begin) (Patient $e0 $x0))` (7) | `(And (Member $e0 commence) (Patient $e0 $x0))` (4) | 0 | A shoreline survey begins at dawn. | A shoreline survey commences at dawn. |
| 0.998 | 5/5 | exclusive (shape-parallel) | 0.42 / 0.23 | `(And (Member $e0 begin) (Patient $e0 $x0))` (7) | `(And (Member $e0 start) (Patient $e0 $x0))` (4) | 0 | A shoreline survey begins at dawn. | A shoreline survey starts at dawn. |
| 0.994 | 5/5 | exclusive (shape-parallel) | 0.39 / 0.44 | `(And (Member $x0 apple_harvest) (Patient $e0 $x0))` (5) | `(And (Member $x0 dress_rehearsal) (Patient $e0 $x0))` (4) | 0 | The apple harvest begins in September. | The dress rehearsal begins after lunch. |
| 0.993 | 5/5 | exclusive (shape-parallel) | 0.39 / 0.45 | `(Inheritance apple_harvest harvest)` (5) | `(Inheritance dress_rehearsal rehearsal)` (5) | 0 | The apple harvest begins in September. | The dress rehearsal begins after lunch. |
| 0.993 | 5/5 | exclusive (shape-parallel) | 0.39 / 0.45 | `(Member $x0 apple_harvest)` (5) | `(Member $x0 dress_rehearsal)` (5) | 0 | The apple harvest begins in September. | The dress rehearsal begins after lunch. |
| 0.993 | 5/5 | exclusive (shape-parallel) | 0.39 / 0.45 | `(Member $x0 apple_harvest)` (5) | `(Member $x0 lunch)` (5) | 0 | The apple harvest begins in September. | The dress rehearsal begins after lunch. |
| 0.993 | 5/5 | exclusive (shape-parallel) | 0.33 / 0.35 | `(And (Future $e0) (Member $x0 apple_harvest) (Patient $e0 $x0))` (4) | `(And (Future $e0) (Member $x0 dress_rehearsal) (Patient $e0 $x0))` (3) | 0 | The apple harvest begins in September. | The dress rehearsal begins after lunch. |
| 0.991 | 5/5 | exclusive (shape-parallel) | 0.29 / 0.32 | `(And (Agent $e0 $x0) (Member $e1 decision) (Patient $e0 $e1) (Theme $e1 $x1))` (3) | `(And (Agent $e0 $x0) (Member $e1 decision) (Theme $e0 $e1) (Theme $e1 $x1))` (3) | 0 | A committee makes a decision on a new roof. | A committee reaches a decision on a new roof. |
| 0.991 | 5/5 | exclusive (shape-parallel) | 0.29 / 0.32 | `(And (Agent $e0 $x0) (Patient $e0 $e1) (Theme $e1 $x1))` (3) | `(And (Agent $e0 $x0) (Theme $e0 $e1) (Theme $e1 $x1))` (3) | 0 | A committee makes a decision on a new roof. | A committee reaches a decision on a new roof. |
| 0.991 | 5/5 | exclusive (shape-parallel) | 0.29 / 0.32 | `(And (Member $e0 decision) (Patient $e1 $e0) (Theme $e0 $x0))` (3) | `(And (Member $e0 decision) (Theme $e0 $x0) (Theme $e1 $e0))` (3) | 0 | A committee makes a decision on a new roof. | A committee reaches a decision on a new roof. |
| 0.991 | 5/5 | exclusive (shape-parallel) | 0.29 / 0.32 | `(And (Patient $e0 $e1) (Theme $e1 $x0))` (3) | `(And (Theme $e0 $e1) (Theme $e1 $x0))` (3) | 0 | A committee makes a decision on a new roof. | A committee reaches a decision on a new roof. |
...
| 1.000 | 5/5 | same-records (shape-parallel) | 0.63 / 0.63 | `(And (Agent $e0 $x0) (Member $e0 buy) (Past $e0))` (14) | `(And (Member $e0 buy) (Past $e0) (Theme $e0 $x0))` (14) | 14 | The depot bought two forklifts. | The depot bought two forklifts. |
...
| 1.000 | 5/5 | same-records (shape-parallel) | 0.63 / 0.63 | `(And (Agent $e0 $x0) (Member $e0 buy))` (14) | `(And (Member $e0 buy) (Theme $e0 $x0))` (14) | 14 | The depot bought two forklifts. | The depot bought two forklifts. |
