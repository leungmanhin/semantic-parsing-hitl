...
CORPORA = {
    ...
    "lore_pending3": ("lore_pending3.jsonl", ["lore_pending3.parses.jsonl"], "external consumer (lore pending re-parse set 3)"),
    "lore_pending4": ("lore_pending4.jsonl", ["lore_pending4.parses.jsonl"], "external consumer (lore pending re-parse set 4)"),
    "lore_pending5": ("lore_pending5.jsonl", ["lore_pending5.parses.jsonl"], "external consumer (lore pending re-parse set 5)"),
    "events":   ("events.jsonl",   ["events.parses.jsonl"],   "external consumer (events.json; one record per episode = passage)"),
    "events_pending": ("events_pending.jsonl", ["events_pending.parses.jsonl"], "external consumer (events pending re-parse set; passages)"),
    "events_pending2": ("events_pending2.jsonl", ["events_pending2.parses.jsonl"], "external consumer (events pending re-parse set 2; passages)"),
